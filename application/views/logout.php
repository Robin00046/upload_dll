...
<body style="background:<?php echo $bgcolor; ?>">
	<div class="col-md-4 col-md-offset-4" style="margin-top:15%">
		<div class="panel panel-default">
			<h3 align="center">Hello, <?php echo $username; ?>! <button type="button" class="btn btn-info btn-sm" onclick="window.location='<?php echo site_url("login/keluar"); ?>'">Logout</button></h3>
		</div>
	</div>
</body>
