<body>
    ...
    <body>
        <div style="padding: 15px;">
            <form method="get" action="<?php echo base_url('surat/filter') ?>">
                <div class="row">
                ...
                if (isset($_GET['filter'])) // Jika user mengisi filter tanggal, maka munculkan tombol untuk reset filter
                    echo '<a href="' . base_url('surat/filter') . '" class="btn btn-default">RESET</a>';
                ?>
            </form>
                        ...
                        <div class="table-responsive">
                            <div class="container">
                                <table class="table table-bordered" id="Table" width="100%" cellspacing="0">
                                    <h3 style="text-align:center"><b>Laporan Surat</b></h3>
                                ...
                                <div style="margin-top: 5px;">
                                    ...
                                    <?php echo $label ?><br />
                                    <h4 style="margin-bottom: 5px;"><b>Data Surat </b></h4>
                                    <thead>
                                        <tr>
                                            <td>No</td>
                                            <td>No Surat </td>
                                    ...
                                    <tbody>
                                        <?php
                                        if (empty($tbl_surat)) { // Jika data tidak ada
                                            echo "<tr><td colspan='5'>Data tidak ada</td></tr>";
                                        } else { // Jika jumlah data lebih dari 0 (Berarti jika data ada)
                                            $no = 1;
                                            foreach ($tbl_surat as $data) { // Looping hasil data transaksi
                                                $tanggal = date('d-m-Y', strtotime($data->tanggal)); // Ubah format tanggal jadi dd-mm-yyyy

                                                echo "<tr>";
                                                echo "<td style='width: 80px;'>" . $no++ . "</td>";
                                                echo "<td style='width: 80px;'>" . $data->no_surat . "</td>";
                                                echo "<td style='width: 80px;'>" . $data->nama_surat . "</td>";
                                                echo "<td style='width: 100px;'>" . $data->tanggal . "</td>";
                                                echo "<td style='width: 300px;'>" . $data->perihal . "</td>";
                                                echo "<td style='width: 60px;'>" . $data->pengirim . "</td>";
                                                echo "<td style='width: 100px;'>" . $data->penerima . "</td>";
